...
for indice, linha in enumerate(sheet_alunos.iter_rows(min_row=2)):
    ...
    desenhar.text((1480, 1182),str(carga_horaria) + " horas",fill='black',font=fonte_geral)
    ...
    image.save(f'./Certificados Automatizados/ {indice} {nome_participante} certificado.png')
